...
//            var overallCost = workunit.cost;
    ...
    //                        var jobCost;
            ...
            var job2;
            for (job2 in header) {
                if (header.hasOwnProperty(job2)) {
                    if (jobResults[job2]) {
                        reportOutput = reportOutput + jobResults[job2];
                    } else {
                        reportOutput = reportOutput + ",,,,,,,,";
                    }
                }
...
//            }
        ...
        var writeReportStream = fs.createWriteStream('workunit_report.csv');
